...
const SORT = {
  'Pertinence-desc': 'Tendances',
  'latest-desc': 'Derniers ajouts',
            ...
            <div className="mb-12 transition ease-in duration-75">
              {data ? (
                <>
                  ...
                  >
                    Affiche {data.products.length} resultats{' '}
                    {q && (
                      <>
                        for "<strong>{q}</strong>"
                      </>
                  ...
                  >
                    {q ? (
                      <>
                        Il n'y a aucun article qui correspond à "<strong>{q}</strong>"
                      </>
                    ) : (
                      <>
            ...
            <div className="lg:hidden">
              <span className="rounded-md shadow-sm">
                <button
                  ...
                  aria-expanded="true"
                >
                  {sort ? SORT[sort as keyof typeof SORT] : 'Pertinence'}
                  <svg
                    className="-mr-1 ml-2 h-5 w-5"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
